 ...
 * svg path animation based on http://24ways.org/2013/animating-vectors-with-svg/ by Brian Suda (@briansuda)
 *
...
(function() {
    // when click the take a look button, open the relative portfolio project
    var triggerBttn1 = document.getElementById('project1');
    var triggerBttn2 = document.getElementById('project2');
    var triggerBttn3 = document.getElementById('project3');
    var triggerBttn4 = document.getElementById('project4');
    var triggerBttn5 = document.getElementById('project5');
    var triggerBttn6 = document.getElementById('project6');
    var triggerBttn7 = document.getElementById('project7');
    var triggerBttn8 = document.getElementById('project8');
    var triggerBttn9 = document.getElementById('project9');
    var triggerBttn10 = document.getElementById('project10');
    var triggerBttn11 = document.getElementById('project11');
    var triggerBttn12 = document.getElementById('project12');
    var triggerBttn13 = document.getElementById('project13');
    var triggerBttn14 = document.getElementById('project14');
    var triggerBttn15 = document.getElementById('project15');
    var triggerBttn16 = document.getElementById('project16');
    var triggerBttn17 = document.getElementById('project17');
    var triggerBttn18 = document.getElementById('project18');
    var triggerBttn19 = document.getElementById('project19');
    var triggerBttn20 = document.getElementById('project20');
    var triggerBttn21 = document.getElementById('project21');
    var triggerBttn22 = document.getElementById('project22');
    var triggerBttn23 = document.getElementById('project23');
    var triggerBttn24 = document.getElementById('project24');
    var triggerBttn25 = document.getElementById('project25');
    var triggerBttn26 = document.getElementById('project26');
    var triggerBttn27 = document.getElementById('project27');
    var triggerBttn28 = document.getElementById('project28'),
    ...
    triggerBttn23.addEventListener('click', toggleOverlay);
    triggerBttn24.addEventListener('click', toggleOverlay);
    triggerBttn25.addEventListener('click', toggleOverlay);
    triggerBttn26.addEventListener('click', toggleOverlay);
    triggerBttn27.addEventListener('click', toggleOverlay);
    triggerBttn28.addEventListener('click', toggleOverlay);
